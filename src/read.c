...
*/
		...
		static const char *card_msgs[] = {
			...
			"ラーン国立銀行", /* Larn */
			"オメガ第一銀行", /* Omega */
			"ゾーク銀行 - Frobozz魔法カード", /* Zork */
			"アンクモルポーク商業組合ポイントカード",
			"アンクモルポーク盗賊ギルド 無期限取引カード",
			"ランスマンスベイ貸金業協会",
			"ゲヘナ銀行 - 利子99%カード",
			"イェンダー・エクスプレス - カッパーカード",
			"イェンダー・エクスプレス - シルバーカード",
			"イェンダー・エクスプレス - ゴールドカード",
			"イェンダー・エクスプレス - ミスリルカード",
			"イェンダー・エクスプレス - プラチナカード",
#endif
		};
		if (Blind) {
/*JP
...
*/
		You_hear("%sが足元で鳴動しているのを聞いた！", surface(u.ux,u.uy));
	    }
	    break;
	case SCR_PUNISHMENT:
		known = TRUE;
...
*/
	on_this_level = only_on_level ? "この階から" : "";
/*JP
	which = "all ";
*/
	which = "全て";
