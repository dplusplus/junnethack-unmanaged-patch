...
#else
static const char *levitate[4]	= { "ïÇÇ≠", "ïÇÇ≠", "ÇÊÇÎÇﬂÇ≠", "ÇÊÇÎÇﬂÇ≠" };
static const char *flys[4]	= { "îÚÇ‘", "îÚÇ‘", "ÇÕÇΩÇﬂÇ≠", "ÇÕÇΩÇﬂÇ≠" };
static const char *flyl[4]	= { "îÚÇ‘", "îÚÇ‘", "ÇÊÇÎÇﬂÇ≠", "ÇÊÇÎÇﬂÇ≠" };
static const char *slither[4]	= { "ääÇÈ", "ääÇÈ", "ÇΩÇ∂ÇÎÇÆ", "ÇΩÇ∂ÇÎÇÆ" };
static const char *ooze[4]	= { "Ç…Ç∂Ç›èoÇÈ", "Ç…Ç∂Ç›èoÇÈ", "êkÇ¶ÇÈ", "êkÇ¶ÇÈ" };
static const char *immobile[4]	= { "êkÇ¶ÇÈ", "êkÇ¶ÇÈ", "êkÇ¶ÇÈ", "êkÇ¶ÇÈ" };
static const char *crawl[4]	= { "ÇÕÇ¢Ç∏ÇÈ", "ÇÕÇ¢Ç∏ÇÈ", "ÇΩÇ∂ÇÎÇÆ", "ÇΩÇ∂ÇÎÇÆ" };
#endif
