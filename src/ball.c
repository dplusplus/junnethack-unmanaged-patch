...
*/
			pline("K‰^‚É‚àA‚ ‚È‚½‚ÍŒÅ‚¢Š•‚ğg‚É‚Â‚¯‚Ä‚¢‚½B");
			dmg = 3;
		    } else if (flags.verbose)
/*JP
			Your("%s does not protect you.", xname(uarmh));
*/
			Your("%s‚Å‚Íç‚ê‚È‚¢B", xname(uarmh));
		}
#if 0 /*JP*/
