...
*/
	    tty_putstr(BASE_WINDOW, 0, "ご新規さん？ Tを押せばチュートリアルを開始します。");
	    tty_putstr(BASE_WINDOW, 0, "");
...
*/
	    tty_putstr(BASE_WINDOW, 0, "キャラクターの選択");
...
*/
		     "秩序のワルキューレ(ドワーフの女性) (直接攻撃と投擲武器が得意)",
		     MENU_UNSELECTED);
	    any.a_int = 2;
...
*/
	    end_menu(win, "どのキャラクターを試してみたいですか？");
