...
*/
	Sprintf(qbuf,"‚±‚ÌŠK‘w‚ð‰½‚ÆŒÄ‚Ñ‚Ü‚·‚©H");
	getlin(qbuf, nbuf);
...
*/
	case BR_PORTAL:	 return closed_portal ? "••ˆó‚³‚ê‚½–‚–@‚Ì“üŒû" : "–‚–@‚Ì“üŒû";
/*JP
	case BR_NO_END1: return "Connection";
*/
	case BR_NO_END1: return "•ªŠò“_";
#if 0 /*JP*/
	case BR_NO_END2: return (br->end1_up) ? "One way stairs up" : 
		"One way stairs down";
#else
	case BR_NO_END2: return (br->end1_up) ? "•Ð“¹‚Ìã‚èŠK’i" : 
		"•Ð“¹‚Ì‰º‚èŠK’i";
#endif
/*JP
...
*/
		Sprintf(buf, TAB "‘æ%iŠE:", -i);
	else
/*JP
		Sprintf(buf, TAB "Level %d:", i);
*/
		Sprintf(buf, TAB "%dŠK:", i);
