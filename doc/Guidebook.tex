...
than the original {\it NetHack\/} palette. If black is not shown as dark
gray, disable this option (default on).
Cannot be set with the `{\tt O}' command.
%.lp
\item[\ib{news}]
...
If this boolean option is false and
{\it autopickup\/} is on, don't pick up things that you have droppped
deliberately, even if they are in {\it pickup_types\/}.
Default is on.
%.lp
